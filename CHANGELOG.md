...
### Changed
- Ship a single bundled `out/extension.js` instead of raw compiled files
  and `node_modules/minimatch`. VSIX size drops from 127 KB to 43 KB
  (~66% smaller); activation loads one file instead of walking the dep
  tree. No user-visible behavior change.
...
[0.6.2]: https://github.com/overdodactyl/roam/releases/tag/v0.6.2
